...
@section('subhead')
    <title>รถพร้อมขาย - carpost-step2</title>
@endsection
                ...
                <div class="col-12">
                    <div class="wrap-boxstep">
                        ...
                        <div class="frm-step-button text-center">
                            <a href="carpost-step1.php" class="btn-step btn-backstep">ย้อนกลับ</a>
                            <a href="carpost-step3.php" class="btn-step btn-nextstep">ถัดไป</a>
                        </div>
                    </div>
                </div>
            </div>
