                ...
                <div class="row">
                    <nav class="col-12 box-menu">
                        <ul>
                            ...
                            <li><a href="car.php"><i class="bi bi-car-front-fill"></i> ซื้อรถยนต์</a></li>
                            <li><a href="car.php"><i class="bi bi-car-front"></i> ดูรถพร้อมขาย</a></li>
                            <li><a href="car.php"><i class="bi bi-stars"></i> รถใหม่</a></li>
                            <li class="hassub">
                                <a><i class="bi bi-newspaper"></i> ข่าวรถ</a>
                                <ul class="submenu">
                                    <li><a href="news.php">ข่าวยานยนต์</a></li>
                                    <li><a href="update-carprice.php">อัพเดทราคารถยนต์</a></li>
                                </ul>
                            </li>
