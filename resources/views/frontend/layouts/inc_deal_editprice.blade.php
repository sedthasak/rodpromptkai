        ...
        <form id="editprice_form" method="POST" action="{{ route('editpriceaction') }}">
            ...
            <div class="row popupdeal-amount">
                ...
                <div class="col-6 col-sm-6">
                    <div class="popupdeal-input"><input type="text" id="current_price" name="current_price" value="" readonly></div>
                </div>
                <div class="col-2">
            ...
            <div class="popupdeal-totalprice">
                <div class="row">
                    <div class="col-4 col-sm-4">
                        <div class="txt-amount-car">ราคาปรับเปลี่ยน</div>
                    </div>
                    <div class="col-6 col-sm-6">
                        <div class="popupdeal-input"><input type="text" id="promotion_price" name="promotion_price" value="" required ></div>
                    </div>
                    <div class="col-2">
                        <div class="txt-amount-car">บาท</div>
                    </div>
