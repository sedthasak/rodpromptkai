                    ...
                    <div class="row">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 col-md-6">
                                                        <div class="box-package-contact">
                                                            ...
                                                            <select name="individual_province">
                                                    ...
                                                    <div class="col-12 col-md-6">
                                                        <div class="box-package-contact">
                                                            ...
                                                            <select name="individual_district">
                                                                <option value="">กรุณาเลือก</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-md-6">
                                                        <div class="box-package-contact">
                                                            ...
                                                            <select name="">
                                                                <option value="individual_subdistrict">กรุณาเลือก</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-md-6">
                                            ...
                                            <div class="w_office box-invoice-type">
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 col-md-6">
                                                        <div class="box-package-contact">
                                                            <label>จังหวัด <span>*</span></label>
                                                            <select name="corporation_province" >
                                                                <option value="">กรุณาเลือก</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-md-6">
                                                        <div class="box-package-contact">
                                                            <label>เขต/อำเภอ <span>*</span></label>
                                                            <select name="corporation_district" >
                                                                <option value="">กรุณาเลือก</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-md-6">
                                                        <div class="box-package-contact">
                                                            <label >แขวง/ตำบล <span>*</span></label>
                                                            <select name="corporation_subdistrict">
                                                                <option value="">กรุณาเลือก</option>
                                                            </select>
                                                        </div>
                                                    </div>
                        ...
                        <!-- <div class="col-12 col-xl-4">
                            <div class="box-sum-cart">
                                ...
                                <input type="hidden" name="price_not_vat" id="price_not_vat" value="" />
                                <input type="hidden" name="vat" id="vat" value="" />

                                <input type="hidden" name="discount" id="discount" value="" />
                                <input type="hidden" name="net_price" id="net_price" value="" />
                                <input type="hidden" name="donate" id="donate" value="" />
                                ...
                                <div class="cartright-box cartright-price">
                                    <div class="row">
                                        ...
                                        <div class="col-4 text-end"><span class="txt-cart-price" id="price_not_vat_show"></span></div>
                                    </div>
                                ...
                                <div class="cartright-box cartright-price">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-4 text-end"><span class="txt-cart-price" id="discount_show">-600.00฿</span></div>
                                    </div>
                                    <div class="row">
                                        <div class="col-8">บริจาคช่วยเหลือหมาแมว สัตว์พิการและสัตว์ด้อยโอกาส</div>
                                        <div class="col-4 text-end"><span class="txt-cart-price" id="donate_show"></span></div>
                                    </div>
                                </div>
                                <div class="cartright-box cartright-price">
                                    <div class="row">
                                        ...
                                        <div class="col-7 text-end">
                                            <span class="txt-totalprice" id="total_show">฿</span>
                                        </div>
                                    </div>
...
<script type="text/javascript">
    document.getElementById('submit-code').addEventListener('click', function() {
        ...
        .then(data => {
            if (data.success) {
                ...
                document.getElementById('discount_show').textContent = `-${data.rate}฿`;
    ...
    function calculateTotal() {
        ...
        var discount = parseFloat(document.getElementById('coupons_rate').value) || 0;
        var price_not_vat = price - discount;
        var vat = price_not_vat * 0.07;
        var total = price_not_vat + vat;

        document.getElementById('price_not_vat').value = price_not_vat.toFixed(2);
        document.getElementById('vat').value = vat.toFixed(2);
        document.getElementById('total').value = total.toFixed(2);

        document.getElementById('price_not_vat_show').textContent = price_not_vat.toFixed(2) + '฿';
