...
?>
    ...
    <div class=" " id="fetchSub_modelss"></div> -->
    ...
    <div class="lg:flex intro-y mt-5 mb-5">
        ...
        <div class="relative">
            <input type="text" name="keyword" id="keyword" class="form-control py-3 px-4 w-full lg:w-64 box pr-10" placeholder="ยี่ห้อ/รุ่น/โฉม/รุ่นย่อย..." value="{{ request()->input('keyword') }}" onkeypress="handleEnter(event)" >
                    ...
                    <tr class="intro-x">
                        ...
                        <td class="table-report__action w-56">
                            <div class="flex justify-center items-center">
                                <a class="flex items-center" href="{{route('BN_sub_models_edit', ['id' => $res->sub_models_id])}}">
...
<script>
    ...
    function applyFilters() {
        ...
        var newUrl = `{{ route('BN_sub_models') }}?keyword=${keyword}`;
