            ...
            <tbody>
                ...
                @endphp
                    <tr class="intro-x">
                        ...
                        <td>
                            <div class="font-medium whitespace-nowrap">{{$res->model}}</div>
                        </td>
                        <td class="table-report__action w-56">
                            <div class="flex justify-center items-center">
                                
                                <!-- <a class="flex items-center text-success mr-3" href="{{route('BN_carmd_edit', ['id' => $res->model_id])}}" >
                                    <i data-lucide="check-square" class="w-4 h-4 mr-1"></i> ดูข้อมูล
                                </a> -->
                                <a class="flex items-center" href="{{route('BN_carmd_edit', ['id' => $res->model_id])}}">
...
<script>
    function applyFilters() {
        ...
        var newUrl = `{{ route('BN_carmd') }}?brand=${brand}&keyword=${keyword}`;
