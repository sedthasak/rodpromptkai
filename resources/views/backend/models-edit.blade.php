                    ...
                    <div class="p-5">
                        ...
                        <div class="sm:grid grid-cols-1 gap-1 mt-5">
                            <div class="">
                                ...
                                <input type="text" class="form-control w-full" id="" name="meta_title" value="{{$model->meta_title}}"  autocomplete="off" />
                            </div>
                        </div>
                        <div class="sm:grid grid-cols-1 gap-1 mt-5">
                            <div class="">
                                <label for="" class="form-label">meta_keyword</label>
                                <input type="text" class="form-control w-full" id="" name="meta_keyword" value="{{$model->meta_keyword}}"  autocomplete="off" />
                            </div>
                        </div>
                        <div class="sm:grid grid-cols-1 gap-1 mt-5">
                            <div class="">
                                <label for="" class="form-label">meta_description</label>
                                <input type="text" class="form-control w-full" id="" name="meta_description" value="{{$model->meta_description}}"  autocomplete="off" />
                            </div>
                        </div>
                        ...
                        <div class="mt-4 flex justify-end">
                            <div class="btn-delete-brand btn btn-danger mr-auto w-24" onclick="confirmDelete({{ $model->id }})">ลบ</div>
...
<script>
    ...
    function confirmDelete(id) {
        Swal.fire({
            title: 'ยืนยัน?',
            text: 'ยืนยันการลบรุ่นรถนี้ใช่ไหม !',
            icon: 'warning',
            ...
            if (result.isConfirmed) {
                ...
                window.location.href = '/backend/car/models-delete/' + id;
            }
        });
    }
</script>
