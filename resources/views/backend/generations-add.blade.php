...
?>
    ...
    <form method="post" action="{{route('BN_generations_add_action')}}" enctype="multipart/form-data" >
        @csrf
                        ...
                        <div class="grid grid-cols-12 gap-x-5">
                            <div class="col-span-12 xl:col-span-6">
                                ...
                                <div class="mt-3">
                                    ...
                                    <input type="text" class="form-control" name="yearfirst" value=""  autocomplete="off" />
                                </div>
                            </div>
                            <div class="col-span-12 xl:col-span-6">
                                <div class="mt-3 xl:mt-0">
                                    <label for="update-profile-form-10" class="form-label">โฉมรถ</label>
                                    <input type="text" class="form-control" name="generations" value=""  autocomplete="off" />
                                </div>
                                <div class="mt-3">
                                    <label for="update-profile-form-13" class="form-label">ปีสุดท้าย</label>
                                    <input type="text" class="form-control" name="yearlast" value=""  autocomplete="off" />
                                </div>
                            </div>
