...
<head>
    ...
    <title>ใบเสร็จรับเงิน (Individual Receipt)</title>
    <style>
        @font-face {
            font-family: 'Sarabun';
            font-style: normal;
...
<body>
    <div class="content">
        ...
        <div class="details">
            ...
            <p><strong>ชื่อ:</strong> {{ $order->individual_name }}</p>
            <p><strong>ที่อยู่:</strong> {{ $order->individual_address }}</p>
            <p><strong>อีเมล:</strong> {{ $order->individual_email }}</p>
            <p><strong>โทรศัพท์:</strong> {{ $order->individual_telephone }}</p>
        </div>
