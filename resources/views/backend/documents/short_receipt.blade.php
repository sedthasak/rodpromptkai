...
<head>
    ...
    <title>ใบเสร็จรับเงินแบบย่อ (Short Receipt)</title>
    <style>
        @font-face {
            font-family: 'Sarabun';
            font-style: normal;
...
<body>
    <div class="content">
        <div class="header">
            <h2>ใบเสร็จรับเงินแบบย่อ</h2>
        </div>
        <div class="details">
            <p><strong>Order Number:</strong> {{ $order->order_number }}</p>
            <p><strong>ชื่อ:</strong> {{ $order->short_name }}</p>
            <p><strong>ที่อยู่:</strong> {{ $order->short_address }}</p>
            <p><strong>อีเมล:</strong> {{ $order->short_email }}</p>
            <p><strong>โทรศัพท์:</strong> {{ $order->short_telephone }}</p>
        </div>
